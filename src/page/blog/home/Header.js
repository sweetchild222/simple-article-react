...
export default function() {
    ...
    return blog ? (
            <div style={{backgroundColor:'#565861', height:'168px', minHeight:'168px', backgroundImage: blog.image != '' && ('url(' + blog.image + '?size=1920x168)'), backgroundSize:'cover', backgroundPosition:'center',  boxShadow: '0 4px 2px -2px black',  position: 'relative'}}>
