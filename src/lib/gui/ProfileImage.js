...
export default function(props) {
    ...
    return user ? 
        (<StateProgsImage src={user.image} tooltip={user.nickname} width={width} height={height}  borderWidth={0} borderRadius={borderRadius} onClick={props.onClick} style={{...props.style}}/>)
        : (isError ? 
