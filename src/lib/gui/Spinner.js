...
export default function({type='default', radius=128, spinnerWidth=13, spinnerColor='rgba(255, 25, 160, 0.5)', top = null}) {
  ...
  return type == 'absolute' ? 
          (<div className={'spinnerProgress'} style={{position:'absolute', width:radius+'px', height:radius+'px', top:(top != null ? top : '32px'), left:calcLeft(), zIndex:'1000', border:spinnerWidth + 'px solid rgba(0, 0, 0, 0)', borderTop: spinnerWidth + 'px solid ' + spinnerColor}}/>)
          :
